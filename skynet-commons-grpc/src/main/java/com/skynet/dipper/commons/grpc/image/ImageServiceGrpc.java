...
public final class ImageServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.skynet.dipper.commons.grpc.image.ImageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImageData,
      com.skynet.dipper.commons.grpc.image.ImageSaveResult> getSaveMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "save",
      requestType = com.skynet.dipper.commons.grpc.image.ImageData.class,
      responseType = com.skynet.dipper.commons.grpc.image.ImageSaveResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImageData,
      com.skynet.dipper.commons.grpc.image.ImageSaveResult> getSaveMethod() {
    io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImageData, com.skynet.dipper.commons.grpc.image.ImageSaveResult> getSaveMethod;
      ...
      synchronized (ImageServiceGrpc.class) {
        if ((getSaveMethod = ImageServiceGrpc.getSaveMethod) == null) {
          ImageServiceGrpc.getSaveMethod = getSaveMethod =
              io.grpc.MethodDescriptor.<com.skynet.dipper.commons.grpc.image.ImageData, com.skynet.dipper.commons.grpc.image.ImageSaveResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "save"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.skynet.dipper.commons.grpc.image.ImageData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.skynet.dipper.commons.grpc.image.ImageSaveResult.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImagePath,
      com.skynet.dipper.commons.grpc.image.ImageLoadResult> getDownloadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "download",
      requestType = com.skynet.dipper.commons.grpc.image.ImagePath.class,
      responseType = com.skynet.dipper.commons.grpc.image.ImageLoadResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImagePath,
      com.skynet.dipper.commons.grpc.image.ImageLoadResult> getDownloadMethod() {
    io.grpc.MethodDescriptor<com.skynet.dipper.commons.grpc.image.ImagePath, com.skynet.dipper.commons.grpc.image.ImageLoadResult> getDownloadMethod;
    if ((getDownloadMethod = ImageServiceGrpc.getDownloadMethod) == null) {
      synchronized (ImageServiceGrpc.class) {
        if ((getDownloadMethod = ImageServiceGrpc.getDownloadMethod) == null) {
          ImageServiceGrpc.getDownloadMethod = getDownloadMethod =
              io.grpc.MethodDescriptor.<com.skynet.dipper.commons.grpc.image.ImagePath, com.skynet.dipper.commons.grpc.image.ImageLoadResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "download"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.skynet.dipper.commons.grpc.image.ImagePath.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.skynet.dipper.commons.grpc.image.ImageLoadResult.getDefaultInstance()))
  ...
  public static final class ImageServiceFutureStub extends io.grpc.stub.AbstractStub<ImageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.skynet.dipper.commons.grpc.image.ImageSaveResult> save(
        com.skynet.dipper.commons.grpc.image.ImageData request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.skynet.dipper.commons.grpc.image.ImageLoadResult> download(
        com.skynet.dipper.commons.grpc.image.ImagePath request) {
      return futureUnaryCall(
  ...
  private static abstract class ImageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.skynet.dipper.commons.grpc.image.ImageProto.getDescriptor();
    }
